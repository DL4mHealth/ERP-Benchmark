...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.channel_mapping = nn.Conv1d(
            ...
            out_channels=16,  # default 16 in BIOT checkpoint pretrained on PREST dataset (200Hz, match our 200Hz data)
            kernel_size=1,
            padding='same',
            bias=False,
        )
        self.model = BIOTClassifier(
            ...
            n_fft=200,
            hop_length=100,
            n_channels=16,  # here is 16 in their pretrained model
        )

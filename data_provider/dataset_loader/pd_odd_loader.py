...
def get_id_list_pd_odd(args, label_path, a=0.6, b=0.8):
    '''
    Loads subject IDs for all, training, validation, and test sets for PD-ODD data
    ...
    for filename in os.listdir(label_path):
        ...
        # [subject_id, disease_id] For PD-ODD, subject ID and disease ID should be the same for all samples a subject
    ...
    # [task_id, odd_type, accuracy, subject_id, disease_id]
...
class PDODDLoader(Dataset):
    def __init__(self, args, root_path, flag=None):
        ...
        a, b = 0.6, 0.8
        self.all_ids, self.train_ids, self.val_ids, self.test_ids = get_id_list_pd_odd(args, self.label_path, a, b)
        ...
        self.y = self.y[:, [4, 3]]  # only keep [disease_id, subject_id] for PD-ODD

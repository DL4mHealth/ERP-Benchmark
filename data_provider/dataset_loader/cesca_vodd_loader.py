...
def get_id_list_cesca_vodd(args, label_path, a=0.6, b=0.8):
    '''
    Loads subject IDs for all, training, validation, and test sets for CESCA-VODD data
...
class CESCAVODDLoader(Dataset):
    def __init__(self, args, root_path, flag=None):
        ...
        a, b = 0.6, 0.8
        self.all_ids, self.train_ids, self.val_ids, self.test_ids = get_id_list_cesca_vodd(args, self.label_path, a, b)
        ...
        self.y = self.y[:, [1, 2]]  # only keep [stimulation_type, subject_id] for CESCA-VODD

...
def get_id_list_cesca_aodd(args, label_path, a=0.6, b=0.8):
    '''
    Loads subject IDs for all, training, validation, and test sets for CESCA-AODD data
    ...
    for filename in os.listdir(label_path):
        ...
        # [task_id, stimulation_type, subject_id, parent_degree]
...
class CESCAAODDLoader(Dataset):
    def __init__(self, args, root_path, flag=None):
        ...
        a, b = 0.6, 0.8
        self.all_ids, self.train_ids, self.val_ids, self.test_ids = get_id_list_cesca_aodd(args, self.label_path, a, b)
        ...
        self.y = self.y[:, [1, 2]]  # only keep [stimulation_type, subject_id] for CESCA-AODD

Dataset raw name: EEG: Three-Stim Auditory Oddball and Rest in Acute and Chronic TBI
Dataset Link: https://openneuro.org/datasets/ds003522/versions/1.1.0
Paper Link: https://www.sciencedirect.com/science/article/abs/pii/S0028393219301630
...
3. Apply a 50 Hz notch filter before bandpass filtering.
4. Apply bandpass filtering with default frequency range: 0.1–30 Hz.
...
- `session_id`: numeric identifier from 'ses-XX'
- `disease_id`:  0: "mTBI", 1: "Control", 2: "Chronic TBI"

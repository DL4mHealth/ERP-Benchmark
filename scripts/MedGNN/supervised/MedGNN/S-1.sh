...
--e_layers 6 --batch_size 128 --n_heads 8 --d_model 128 --d_ff 256 --resolution_list 2,4,6,8 --nodedim 10 --use_subject_vote --swa \
...
# mTBI-ODD
python -u run.py --method MedGNN \
--task_name supervised --is_training 1 --root_path ./dataset/200Hz/ --model_id S-mTBI-ODD --model MedGNN --data MultiDatasets \

...
--e_layers 6 --batch_size 64 --n_heads 8 --d_model 128 --d_ff 256 --patch_len 100 --use_subject_vote --swa \
--des 'Exp' --itr 5 --learning_rate 0.0001 --train_epochs 200 --patience 15
...
--e_layers 6 --batch_size 128 --n_heads 8 --d_model 128 --d_ff 256 --patch_len 100 --swa \
--des 'Exp' --itr 5 --learning_rate 0.0001 --train_epochs 200 --patience 15
...
# mTBI-ODD
python -u run.py --method PatchTST \
--task_name supervised --is_training 1 --root_path ./dataset/200Hz/ --model_id S-mTBI-ODD --model PatchTST --data MultiDatasets \
